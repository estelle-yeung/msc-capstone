...
Refer to 'jul20.Rmd' to scrape tweets using academicTwitteR.

Refer to 'jul04.Rmd' for data cleaning and EDA 

Refer to 'jul20.Rmd' for sentiment analysis using SentimentR and Naive-Bayes supervised machine learning
